...
//     d3.selectAll("svg > *").data([]).exit().remove();
    ...
    var fieldsById = d3.nest().key(function(d) {return d.id;})
            ...
            radios0.onclick = function(){
                if (field.id == "pepercapita" && radios0.checked){
                    ...
                    d3.select("#map-container > svg > text").remove();
                    d3.select("#map-container > svg").append("text").attr("x",5).attr("y","88%").attr("dy",".35em").text("Units: CO2 Emission (Billion Metric Tonnes)");
                    ...
                    d3.select("#map-container > svg > text").remove();
                    d3.select("#map-container > svg").append("text").attr("x",5).attr("y","88%").attr("dy",".35em").text("Units: GDP PPP (Trillion 2005 US Dollar)");
            };
        };
            ...
            radios1.onclick = function(){
                if (field.id == "PECons" && radios1.checked){
                    ...
                    colors = mycolor_blue.map(function(rgb) { return d3.hsl(rgb); });
                    d3.select("#map-container > svg > text").remove();
                    d3.select("#map-container > svg").append("text").attr("x",5).attr("y","88%").attr("dy",".35em").text("Units: Primary Energy Consumption Per Capita (Million BTU)");
                    addSummation();
                    ...
                    colors = mycolor_green.map(function(rgb) { return d3.hsl(rgb); });
                    d3.select("#map-container > svg > text").remove();
                    d3.select("#map-container > svg").append("text").attr("x",5).attr("y","88%").attr("dy",".35em").text("Units: CO2 Emission Per Capita (Metric Tonnes)");
                    addSummation();
                    ...
                    colors = mycolor_orange.map(function(rgb) { return d3.hsl(rgb); });
                    d3.select("#map-container > svg > text").remove();
                    d3.select("#map-container > svg").append("text").attr("x",5).attr("y","88%").attr("dy",".35em").text("Units: GDP PPP Per Capita (Thousand 2005 US Dollar)");
                    addSummation();
                };
            };
    ...
    var populationSelect = d3.select('.button.-red').on("click",function(e){
        ...
        d3.select("#map-container > svg > text").remove();
        d3.select("#map-container > svg").append("text").attr("x",5).attr("y","88%").attr("dy",".35em").text("Units: Population (Millions)");
