...
function addSummation(){
    ...
    if (field2.id=="PECons"){
        d3.select("#map-container > svg").append("text").attr("class","summation_units").attr("x","88%").attr("y","90%").text("Quadrillion BTU");
    }else if (field2.id=="Carbon"){
        d3.select("#map-container > svg").append("text").attr("class","summation_units").attr("x","86%").attr("y","90%").text("Billion Metric Ton");
    }else if (field2.id=="GDP"){
        d3.select("#map-container > svg").append("text").attr("class","summation_units").attr("x","88%").attr("y","90%").text("Trillion Dollar");
